...
from attack_models import autoencoders, unet
...
def get_case_attack_configuration(dataset):
    ...
    data['attack_rate'] = general_args.attack_rate if general_args.attack_rate is not None else 0.5
    return data
            ...
            for rnd in range(15):
                ...
                for _ in range(10):
                    for batch_idx, (data, target) in enumerate(true_class_all_loader):
                        ...
                        raw_noise  = atkmodel(data) * general_args.atk_eps
                        noise      = proj(raw_noise, noise_reg_eps)
